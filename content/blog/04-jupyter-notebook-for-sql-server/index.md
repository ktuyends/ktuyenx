...
Ồ có khá nhiều drivers, cơ mà mình cũng không hiểu rõ lắm về những drivers này. Với bài viết này, mình sẽ sử dụng `ODBC Driver 17 for SQL Server`.
...
<p align="center"><img src="sql2.png" width=60% ></p>
